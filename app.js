    ...
    while(correct === false){
        if(correctAns === parseInt(guess)){
            ...
            if(names.name && attempts.length<names.name){
                alert(`That's correct, ${name}! The answer was ${correctAns}. You got it right in ${attempts.length}. These are your guesses: ${attempts.join()}. You did ${names.name-attemps.length} guesses better than your previous try`);
            }
            else{
                alert(`That's correct, ${name}! The answer was ${correctAns}. You got it right in ${attempts.length}. These are your guesses: ${attempts.join()}. You did ${attempts.length-names.name} guesses worse than your previous try`);
                correct = true;
